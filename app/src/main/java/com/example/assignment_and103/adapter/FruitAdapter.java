...
import com.example.assignment_and103.databinding.ItemFruitBinding;
...
public class FruitAdapter  extends RecyclerView.Adapter<FruitAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.tvPrice.setText("Price: "+fruit.getPrice());
        holder.binding.tvQuality.setText("Quantity: "+fruit.getQuantity());
